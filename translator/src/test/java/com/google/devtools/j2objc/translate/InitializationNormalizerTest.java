...
public class InitializationNormalizerTest extends GenerationTest {
  ...
  public void testStaticInitializerBlock() throws IOException {
    ...
    assertTranslatedLines(
        ...
        + (void)initialize {
          if (self == [Test class]) {
            {
              [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, out))) printlnWithNSString:@"foo"];
            }
            J2OBJC_SET_INITIALIZED(Test)
          }
        }
  ...
  public void testStringConcatWithInvalidCppCharacters() throws IOException {
    ...
    String source =
        """
        class Test {
          static final String foo = "hello" + 1 + "\udfff";
        }
        """;
    String translation = translateSourceFile(source, "Test", "Test.m");
    assertInTranslation(translation, "NSString *Test_foo;");
  ...
  public void testStaticFinalStringAssignedToStaticFinalString() throws IOException {
    String source =
        """
        class Test {
          static final String FOO = Inner.BAR;
          class Inner {
  ...
  public void testTranslateObject() throws IOException {
    ...
    String source =
        ...
        """;
    String path = addSourceFile(source, filename + ".java");
  ...
  public void testConstantInitializedByConditionalOnConstants() throws IOException {
    String source =
        ...
        class Test {
          ...
          private static final int C = A < B ? A : B;
        }
        """;
    String translation = translateSourceFile(source, "Test", "Test.m");
  ...
  public void testDoubleBraceInitialization() throws IOException {
    String source =
        ...
        import java.util.*;
        class Test {
          static final Map<String, String> test =
  ...
  public void testConstantStringInitializationOrder() throws IOException {
    String source =
        """
        class Test {
          private static final int CODE_POINT = getCodePoint();
          private static final String FOO = "\uda6e";
          static int getCodePoint() {
            return FOO.codePointAt(0);
          }
        }
        """;
    String translation = translateSourceFile(source, "Test", "Test.m");
  ...
  public void testNullInitializationIsStripped() throws IOException {
    String translation =
        translateSourceFile(
            """
            class test {
              private static Object CLASS_LOCK = null;
            }
            """,
            "Test",
            "Test.m");
