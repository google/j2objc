...
public class ObjectiveCImplementationGeneratorTest extends GenerationTest {
  ...
  public void testClassField() throws IOException {
    ...
    assertTranslation(translation, "int newFieldBar_;");
    assertTranslation(translation, "J2OBJC_STATIC_FIELD_GETTER(FooBar, fieldPhi, jint)");
    assertTranslation(translation, "J2OBJC_STATIC_FIELD_REF_GETTER(FooBar, fieldPhi, jint)");
  }
  ...
  public void testPackageInfoClassWithPrefix() throws IOException {
    ...
    assertTranslation(translation, "FBpackage_info");
    assertNotInTranslation(translation, "FooBarPackage_info");
  }
