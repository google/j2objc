...
public class InnerClassExtractorTest extends GenerationTest {
  ...
  public void testInnerInnerClass() throws IOException {
    ...
    String translation = translateSourceFile(source, "A", "A.h");
    assertTranslation(translation, "- (instancetype)initWithA:(A *)outer$;");
    assertTranslation(translation, "- (instancetype)initWithA$B:(A$B *)outer$;");
    translation = getTranslatedFile("A.m");
    assertTranslation(translation, "A *this$0_;");
    assertTranslation(translation, "A$B *this$0_;");
  ...
  public void testWeakInnerInnerClass() throws IOException {
    ...
    String translation = translateSourceFile(source, "A", "A.m");
    assertTranslation(translation, "A *this$0_;");
    assertTranslation(translation, "__weak A$B *this$0_;");
    assertTranslation(translation, "[nil_chk(this$0_->this$0_->o_) hash]");
  }
  ...
  public void testInnerMethodAnonymousClass() throws IOException {
    ...
    assertTranslatedLines(translation,
        "- (instancetype)initWithA$B:(A$B *)outer$",
        "withInt:(jint)capture$0;");
    assertTranslation(translation, "A *this$0_;");
    assertTranslation(translation, "A$B *this$1_;");
    assertTranslation(translation, "jint val$j_;");
    assertTranslatedLines(translation,
        "void A$B$$1_initWithA$B_withInt_(A$B$$1 *self, A$B *outer$, jint capture$0) {",
        "  JreStrongAssign(&self->this$1_, outer$);",
        "  self->val$j_ = capture$0;",
        "  A$C_initWithA_(self, outer$->this$0_);",
        "}");
  ...
  public void testStaticInnerClass() throws IOException {
    ...
    assertTranslatedLines(translation,
        "void Test$Foo_init(Test$Foo *self) {",
        "  Test$Foo_initWithInt_(self, 0);",
        "}");
    assertTranslatedLines(translation,
        "void Test$Foo_initWithInt_(Test$Foo *self, jint i) {",
        "  NSObject_init(self);",
        "  self->i_ = i;",
        "}");
  }
  ...
  public void testInnerClassDefaultInitialization() throws IOException {
    ...
    assertTranslation(translation, "JreStrongAssignAndConsume(&self->inner_, "
        + "new_Test$Inner_initWithTest_withBoolean_(self, true));");
    assertTranslation(translation, "JreStrongAssign(&self->this$0_, outer$);");
  }
  ...
  public void testOuterInterfaceMethodReference() throws IOException {
    ...
    assertTranslation(translation,
        "- (Test$Bar$Inner *)makeInner {\n"
        + "  return [new_Test$Bar$Inner_initWithTest$Bar_(self) autorelease]");
    assertTranslation(translation, "[new_Test$Bar$Inner_initWithTest$Bar_(bar) autorelease];");
  }
  ...
  public void testMultipleThisReferences() throws IOException {
    ...
    assertTranslation(translation, "new_A$Inner$$1_initWithA$Inner_(self)");
  ...
  public void testInnerSubClassOfGenericClassInner() throws IOException {
    ...
    assertTranslation(translation, "@interface Test$B$BInner : Test$A$Inner");
  }
  ...
  public void testInnerSubClassOfOtherInnerWithOuterRefs() throws IOException {
    ...
    assertTranslation(translation, "@interface Test$A$Inner () {\n @public\n  Test$A *this$0_;");
    assertTranslation(translation, "@interface Test$B$BInner () {\n @public\n  Test$B *this$1_;");

    // Check that B has a constructor that correctly calls constructor of A
    // with right outer.
    assertTranslatedLines(translation,
        "void Test$B_initWithTest_(Test$B *self, Test *outer$) {",
        "  Test$A_initWithTest_(self, outer$);",
        "}");
  }
  ...
  public void testInnerClassInstantiatesAnotherInner() throws IOException {
    String translation = translateSourceFile(
        ...
        "Test", "Test.m");
    assertTranslation(translation, "new_Test$Inner1_initWithTest_(outer$)");

    translation = getTranslatedFile("Test.h");
    assertTranslation(translation,
        "@interface Test$Inner2 : NSObject {\n"
        + " @public\n"
        + "  Test$Inner1 *inner1_;");
  }
  ...
  public void testInnerClassWithInnerSuperClass() throws IOException {
    String translation = translateSourceFile(
        ...
        "Test", "Test.m");
    assertTranslation(translation, "Test$Inner1_initWithTest_withInt_(self, outer$, n);");
  }
  ...
  public void testInnerSubClassOfOtherInnerWithOuterRefsExtraction() throws IOException {
    ...
    assertNotInTranslation(translation, "@interface Test$B ()");
    ...
    assertTranslatedLines(translation,
        ...
        "Test_initialize();",
        "Test$B *b = [new_Test$B_initWithTest_([new_Test_init() autorelease]) autorelease];");

    // Verify that BInner's constructor takes a B instance and correctly calls
    // the super constructor.
    assertTranslatedLines(translation,
        "void Test$B$BInner_initWithTest$B_(Test$B$BInner *self, Test$B *outer$) {",
        "  Test$A$Inner_initWithTest$A_(self, outer$);",
        "}");
  }
  ...
  public void testInnerSubClassOfOtherInnerWithOuterRefsWithGenerics() throws IOException {
    ...
    assertTranslation(translation,
        "Test$A$Inner_initWithTest$A_withTest$A$Inner_(self, outer$, nil);");
  }
  ...
  public void testMethodInnerClass() throws IOException {
    String source = "public class A { void foo() { class MyRunnable implements Runnable {"
        + "public void run() {} }}}";
    String translation = translateSourceFile(source, "A", "A.m");
    assertTranslation(translation, "@interface A$1MyRunnable : NSObject < JavaLangRunnable >");
  ...
  public void testInnerClassConstructor() throws IOException {
    ...
    String translation = translateSourceFile(source, "A", "A.m");
    assertTranslation(translation, "return [new_A$B_initWithA_(this$0_) autorelease];");
  }
  ...
  public void testMethodInnerClassWithSameName() throws IOException {
    ...
    String translation = translateSourceFile(source, "A", "A.h");
    assertTranslation(translation, "@interface A$MyClass");
    translation = getTranslatedFile("A.m");
    assertTranslation(translation, "@interface A$1MyClass");
  }
  ...
  public void testOuterThisReferenceInInner() throws IOException {
    String translation = translateSourceFile(
        ...
        "Test", "Test.m");
    assertTranslation(translation, "new_Test$Inner_initWithTest_withInt_(this$0_, 1)");
    assertTranslation(translation, "new_Test$Inner_initWithTest_withInt_(self, 2)");
  }
  ...
  public void testInnerThisReferenceInInnerAsThisExpression() throws IOException {
    String translation = translateSourceFile(
        ...
        "Test", "Test.m");
    assertTranslation(translation, "Test_fooWithTest$Inner_(self)");
  }
  ...
  public void testNoOuterInStaticInitializer() throws IOException {
    ...
    translation = getTranslatedFile("A.m");
    assertNotInTranslation(translation, "this$0_");
    assertTranslation(translation, "A_fooWithId_([new_A$$1_init() autorelease])");
  }
  ...
  public void testNoOuterWhenAssignedToStaticField() throws IOException {
    ...
    assertFalse(translation.contains("this$0_"));
    assertTranslation(translation,
        "JreStrongAssignAndConsume(&A_test, new_A$$1_init());");
  }
  ...
  public void testNoOuterWhenInStaticMethod() throws IOException {
    ...
    assertFalse(translation.contains("this$0_"));
    assertTranslation(translation,
        "return [new_A$$1_initWithJavaUtilCollection_(c) autorelease];");
    assertTranslation(translation,
        "- (instancetype)initWithJavaUtilCollection:(id<JavaUtilCollection>)capture$0 {");
  }
  ...
  public void testCreateInnerClassOfSuperclass() throws IOException {
    String source = "class B {\n"
        ...
        + "}\n";
    String translation = translateSourceFile(source, "A", "A.m");
    assertTranslation(translation, "new_B$C_initWithB_(self)");
  }
  ...
  public void testCallInnerConstructorOfParameterizedOuterClass() throws IOException {
    ...
    assertTranslation(translation,
        "[new_Outer$Inner_initWithOuter_withId_(self, @\"test\") autorelease];");
  }
  ...
  public void testNoOuterFieldAssignmentWhenCallingOtherConstructor() throws IOException {
    ...
    assertTranslatedLines(translation,
        "void Outer$Inner_initWithOuter_(Outer$Inner *self, Outer *outer$) {",
        "  Outer$Inner_initWithOuter_withInt_(self, outer$, 42);",
        "}");
  }
  ...
  public void testInnerClassVarargsConstructor() throws IOException {
    String translation = translateSourceFile(
        ...
        "Test", "Test.m");
    assertTranslation(translation,
        "new_Test$Inner_initWithTest_withIntArray_(self, "
  ...
  public void testInnerClassConstructedInSuperConstructorInvocation() throws IOException {
    ...
    assertTranslation(translation, "new_Outer$Inner1_initWithOuter_(outer$)");
  }
  ...
  public void testOuterReferenceInSuperConstructorInvocation() throws IOException {
    ...
    assertTranslation(translation,
        "Outer$Inner1_initWithOuter_withInt_(self, outer$, outer$->foo_);");
  }
  ...
  public void testOuterThisReferenceInSuperConstructorInvocation() throws IOException {
    ...
    assertTranslation(translation,
        "Outer$Outer1$Inner1_initWithOuter$Outer1_withInt_(self, outer$, outer$->this$0_->foo_);");
  }
  ...
  public void testAnonymousClassWithinTypeDeclarationStatement() throws IOException {
    ...
    assertOccurrences(translation, "@interface Test$1MyRunnable$$1", 1);
  }
  ...
  public void testLocalClassWithCaptureVariables() throws IOException {
    String translation = translateSourceFile(
        ...
        + "  new Inner(); } }",
        "Test", "Test.m");
    assertTranslation(translation, "new_Test$1Inner_initWithNSString_(s)");
    assertTranslatedLines(translation,
        "void Test$1Inner_initWithNSString_(Test$1Inner *self, NSString *capture$0) {",
        "  Test$1Inner_initWithNSString_withInt_(self, capture$0, 0);",
        "}");
    assertTranslatedLines(translation,
        "void Test$1Inner_initWithNSString_withInt_("
          + "Test$1Inner *self, NSString *capture$0, jint i) {",
  ...
  public void testInnerClassWithVarargsAndCaptureVariables() throws IOException {
    ...
    assertTranslation(translation,
        "new_Test$1Inner_initWithInt_withNSObjectArray_(i, "
        + "[IOSObjectArray arrayWithObjects:(id[]){ o } count:1 type:NSObject_class_()])");
    assertTranslation(translation,
        "void Test$1Inner_initWithInt_withNSObjectArray_("
        + "Test$1Inner *self, jint capture$0, IOSObjectArray *o)");
  }
}
