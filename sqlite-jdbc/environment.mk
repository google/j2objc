...
SQLITEJDBC_SRC_JAR = $(JAVA_DEPS_JAR_DIR)/$(SQLITEJDBC_SOURCE_JAR)
SQLITEJDBC_JAR_FULL = $(JAVA_DEPS_JAR_DIR)/$(SQLITEJDBC_JAR)

OBJCFLAGS := $(CC_WARNINGS) $(DEBUGFLAGS)

# J2ObjC settings
J2OBJC = $(DIST_DIR)/j2objc -classpath $(SQLITEJDBC_JAR_FULL) -d $(BUILD_DIR)
