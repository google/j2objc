...
- (void)testBooleanType {
  ...
  NSString *expectedObjectTypeName =
      JreSupportsReflection() ? @"java.lang.Boolean" : @"JavaLangBoolean";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
...
- (void)testByteType {
  ...
  NSString *expectedObjectTypeName = JreSupportsReflection() ? @"java.lang.Byte" : @"JavaLangByte";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
...
- (void)testCharType {
  ...
  NSString *expectedObjectTypeName =
      JreSupportsReflection() ? @"java.lang.Character" : @"JavaLangCharacter";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
...
- (void)testDoubleType {
  ...
  NSString *expectedObjectTypeName =
      JreSupportsReflection() ? @"java.lang.Double" : @"JavaLangDouble";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
...
- (void)testFloatType {
  ...
  NSString *expectedObjectTypeName =
      JreSupportsReflection() ? @"java.lang.Float" : @"JavaLangFloat";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
...
- (void)testIntType {
  ...
  NSString *expectedObjectTypeName =
      JreSupportsReflection() ? @"java.lang.Integer" : @"JavaLangInteger";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
...
- (void)testLongType {
  ...
  NSString *expectedObjectTypeName = JreSupportsReflection() ? @"java.lang.Long" : @"JavaLangLong";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
...
- (void)testShortType {
  ...
  NSString *expectedObjectTypeName =
      JreSupportsReflection() ? @"java.lang.Short" : @"JavaLangShort";
  XCTAssertEqualObjects(objectTypeName, expectedObjectTypeName, @"incorrect object type name");
