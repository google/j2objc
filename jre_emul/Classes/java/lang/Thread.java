...
public class Thread implements Runnable {
  ...
  private static native void initializeThreadClass() /*-[
    ...
    pthread_setspecific(java_thread_key, (ARCBRIDGE_RETAINED void*)RETAIN_(mainThread));
  ]-*/;
  ...
  public static native Thread currentThread() /*-[
    ...
    pthread_setspecific(java_thread_key, (ARCBRIDGE_RETAINED void*)RETAIN_(thread));
    return thread;
  ]-*/;
