...
public class TextUtilsTest extends TestCase {
    ...
    /*
    TODO(tball): enable when styles are supported.
    @LargeTest
    ...
    */
    ...
    /*
    TODO(tball): enable when parcels are supported.
    @SmallTest
    ...
    */
    ...
    protected static class MockSpanned implements Spanned, CharSequence {
        ...
        public String toString() {
          return "MockSpanned " +
              Arrays.toString(TextUtils.removeEmptySpans(allSpans.toArray(), this, Object.class));
        }
    }
}
