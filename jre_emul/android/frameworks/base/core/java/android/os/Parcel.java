...
public final class Parcel  {
    ...
    private ByteBuffer buf = ByteBuffer.wrap(null);
...
//    public static native long getGlobalAllocCount();
    ...
    public final int dataSize() {
        return buf.position() + buf.remaining();
...
//    }
    ...
    public final void writeByteArray(byte[] b, int offset, int len) {
        ...
        Arrays_checkOffsetAndCount(b.length, offset, len);
...
//    }
    ...
    private Parcel(ByteBuffer nativePtr) {
        if (DEBUG_RECYCLE) {
    ...
    private void init(ByteBuffer buff) {
        if (buff != null) {
            this.buf = buff;
...
//    }
    ...
    // ZZ++
    private void Arrays_checkOffsetAndCount(int arrayLength, int offset, int count) {
