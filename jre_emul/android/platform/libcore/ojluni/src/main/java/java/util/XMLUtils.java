...
/**
 * A class used to aid in Properties load and save in XML. Keeping this code outside of Properties
 * helps reduce the number of classes loaded when Properties is loaded.
 *
