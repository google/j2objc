    ...
    implements Comparable<Charset>
{
    ...
    */
    ...
    // J2ObjC-removed: removed charset providers support, as there's no customer demand,
    // and the ServiceLoader closure would increase jre_core's size.
...
//    }
    ...
    private static Charset lookup2(String charsetName) {
        ...
        // providers.
        // j2objc: use IOSCharset
        if ((cs = IOSCharset.charsetForName(charsetName))  != null)
        {
    ...
    public static SortedMap<String,Charset> availableCharsets() {
        //j2objc: simplified, use IOSCharset.
