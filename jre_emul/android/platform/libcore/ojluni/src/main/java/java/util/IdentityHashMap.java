    ...
    implements Map<K,V>, java.io.Serializable, Cloneable
{
    ...
    {
        private IdentityEntry lastReturnedEntry = null;

        public Map.Entry<K,V> next() {
            lastReturnedEntry = new IdentityEntry(traversalTable, nextIndex());
    ...
    // IdentityEntry has been extracted from being an inner class of EntryIterator to break the
    // reference cycle that was created by EntryIterator's lastReturnedEntry field.
    private class IdentityEntry implements Map.Entry<K,V> {
        private final Object[] traversalTable;
        private int index;

        private IdentityEntry(Object[] traversalTable, int index) {
