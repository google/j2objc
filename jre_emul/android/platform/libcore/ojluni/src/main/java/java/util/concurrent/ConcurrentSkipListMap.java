...
public class ConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
    ...
    // containing map. Added volatile keyword because the racy initialization that's used
    // is unsafe when translated to Objective-C.
    /** Lazily initialized key set */
    @RetainedWith private transient volatile KeySet<K,V> keySet;
    /** Lazily initialized entry set */
    @RetainedWith private transient volatile EntrySet<K,V> entrySet;
    /** Lazily initialized values collection */
    @RetainedWith private transient volatile Values<K,V> values;
    ...
    static final class SubMap<K,V> extends AbstractMap<K,V>
        ...
        @RetainedWith private transient volatile KeySet<K,V> keySetView;
        @RetainedWith private transient volatile Set<Map.Entry<K,V>> entrySetView;
        @RetainedWith private transient volatile Collection<V> valuesView;
