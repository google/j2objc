    ...
    implements NavigableMap<K,V>, Cloneable, java.io.Serializable
{
    ...
    @RetainedWith private transient NavigableMap<K, V> descendingMap;
    ...
    public NavigableMap<K, V> descendingMap() {
        ...
        return (km != null) ? km :
            (descendingMap = new DescendingSubMap<>(this, this,
                                                    true, null, true,
                                                    true, null, true));
    }
    ...
    public NavigableMap<K,V> subMap(K fromKey, boolean fromInclusive,
        ...
        return new AscendingSubMap<>(this, null,
    ...
    static final class KeySet<E> extends AbstractSet<E> implements NavigableSet<E> {
        ...
        - (NSUInteger)countByEnumeratingWithState:(NSFastEnumerationState *)state
          ...
          JavaUtilTreeMap *m;
          BOOL ascending = YES;
          if ([m_ isKindOfClass:[JavaUtilTreeMap class]]) {
            m = (JavaUtilTreeMap *)m_;
            SetEndpoints(m, state);
          } else {
            JavaUtilTreeMap_NavigableSubMap *sm = (JavaUtilTreeMap_NavigableSubMap *)
                cast_chk(m_, [JavaUtilTreeMap_NavigableSubMap class]);
            m = sm->m_;
            ascending = [sm isKindOfClass:[JavaUtilTreeMap_AscendingSubMap class]];
            SetSubMapEndpoints(sm, state, ascending);
          }
          return EnumerateEntries(m, state, stackbuf, len, 1, ascending);
        }

        RETAINED_WITH_CHILD(m_)
        ]-*/
    }
    ...
    abstract static class NavigableSubMap<K,V> extends AbstractMap<K,V>
        ...
        /**
         * The descending navigable map that was provided at construction time, if present. If one
         * was not provided at construction time, the descending map will be constructed on demand
         * and then cached in a field declared in the superclass, {@code #descendingMapView}.
         */
        final transient NavigableMap<K,V> dm;
        ...
        NavigableSubMap(TreeMap<K,V> m, NavigableMap<K,V> dm,
        ...
        public final NavigableMap<K,V> descendingMap() {
            return dm != null ? dm : descendingMapView();
        }

        abstract NavigableMap<K,V> createDescendingMapView();

        private NavigableMap<K,V> descendingMapView() {
            NavigableMap<K,V> mv = descendingMapView;
            return (mv != null) ? mv :
                (descendingMapView = createDescendingMapView());
        }

        // Views
        @RetainedWith transient NavigableMap<K, V> descendingMapView;
    ...
    static final class AscendingSubMap<K,V> extends NavigableSubMap<K,V> {
        ...
        AscendingSubMap(TreeMap<K,V> m, NavigableMap<K,V> dm,
                        boolean fromStart, K lo, boolean loInclusive,
                        boolean toEnd,     K hi, boolean hiInclusive) {
            super(m, dm, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
        }
        ...
        public NavigableMap<K,V> subMap(K fromKey, boolean fromInclusive,
            ...
            return new AscendingSubMap<>(m, null,
                                         false, fromKey, fromInclusive,
                                         false, toKey,   toInclusive);
        }
        ...
        @Override
        NavigableMap<K,V> createDescendingMapView() {
            return new DescendingSubMap<>(m, this,
                                          fromStart, lo, loInclusive,
                                          toEnd,     hi, hiInclusive);
        }
    ...
    static final class DescendingSubMap<K,V>  extends NavigableSubMap<K,V> {
        ...
        DescendingSubMap(TreeMap<K,V> m, NavigableMap<K,V> dm,
                        boolean fromStart, K lo, boolean loInclusive,
                        boolean toEnd,     K hi, boolean hiInclusive) {
            super(m, dm, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
        }
        ...
        public NavigableMap<K,V> subMap(K fromKey, boolean fromInclusive,
            ...
            if (!inRange(toKey, toInclusive))
                throw new IllegalArgumentException("toKey out of range");
            return new DescendingSubMap<>(m, null,
                                          false, toKey,   toInclusive,
                                          false, fromKey, fromInclusive);
        }
        ...
        @Override
        NavigableMap<K,V> createDescendingMapView() {
            return new AscendingSubMap<>(m, this,
                                         fromStart, lo, loInclusive,
                                         toEnd,     hi, hiInclusive);
        }
    ...
    private class SubMap extends AbstractMap<K,V>
        ...
        private Object readResolve() {
            return new AscendingSubMap<>(TreeMap.this, null,
    ...
    static inline void SetEndpoints(
      ...
      if (state->state == 0) {
        state->extra[1] = (unsigned long) [map getFirstEntry];
        state->extra[2] = (unsigned long) nil;
      }
    }
    ]-*/

    /*-[
    static inline void SetSubMapEndpoints(
        __unsafe_unretained JavaUtilTreeMap_NavigableSubMap *map, NSFastEnumerationState *state,
        BOOL ascending) {
      if (state->state == 0) {
        state->extra[1] = (unsigned long)(ascending ? [map absLowest] : [map absHighest]);
        state->extra[2] = (unsigned long)(ascending ? [map absHighFence] : [map absLowFence]);
      }
    }
    ]-*/
    ...
    static NSUInteger EnumerateEntries(
      ...
      __unsafe_unretained JavaUtilTreeMap_TreeMapEntry *node;
      __unsafe_unretained JavaUtilTreeMap_TreeMapEntry *startNode =
          (ARCBRIDGE id) (void *) state->extra[1];
      __unsafe_unretained JavaUtilTreeMap_TreeMapEntry *endNode =
      ...
      while (node && node != endNode && objCount < len) {
        switch (type) {
        ...
        objCount++;
        node = forward
            ? JavaUtilTreeMap_successorWithJavaUtilTreeMap_TreeMapEntry_(node)
            : JavaUtilTreeMap_predecessorWithJavaUtilTreeMap_TreeMapEntry_(node);
      }
