    ...
    implements java.io.Serializable, Cloneable, Comparable<Date>
{
    ...
    /**
     * The from(Instant) and toInstant() methods *are* J2ObjC compatible, but
     * we're reusing J2ObjCIncompatible so that these methods are included in
     * jre_emul.jar but are not transpiled. A native version of these methods are
     * instead in a JavaUtilDate category in java/time/Instant.java. This allows
     * these methods to be supported without the verhead of jre_icu and jre_time 
     * for those apps that don't use java.time.Instant.
    */
    /**
