    ...
    implements java.io.Serializable, Cloneable
{
    ...
    private class EntryIterator extends EnumMapIterator<Map.Entry<K,V>> {
        private EnumMapEntry lastReturnedEntry = null;

        public Map.Entry<K,V> next() {
            if (!hasNext())
                throw new NoSuchElementException();
            lastReturnedEntry = new EnumMapEntry(index++);
    ...
    // EnumMapEntry has been extracted from being an inner class of EntryIterator to break the
    // reference cycle that was created by EntryIterator's lastReturnedEntry field.
    private class EnumMapEntry implements Map.Entry<K,V> {
        private int index;

        private EnumMapEntry(int index) {
            this.index = index;
        }
