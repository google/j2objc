...
// j2objc-removed: import dalvik.annotation.codegen.CovariantReturnType;
    ...
    implements Comparable<ByteBuffer>
{
    ...
    // j2objc-removed: @CovariantReturnType(returnType = ByteBuffer.class, presentAfter = 28)
    @Override
    ...
    public final int alignmentOffset(int index, int unitSize) {
        ...
        final long baseAddress =
            isDirect() ? address : (sun.misc.Unsafe.getUnsafe().arrayBaseOffset(byte[].class) + offset);
