...
public class Throwable extends NSException implements Serializable {
    ...
    public Throwable(Throwable cause) {
        /* J2ObjC: delegate to sibling constructor so that the detail message can be passed up to
         * NSException.
        fillInStackTrace();
    ...
    // J2ObjC added: Override NSException isEqual and hash behavior. Use a OCNI block so that the
    // methods don't show up in reflection.
    /*-[
