...
#define CREATE_DOUBLE_BITS(normalizedM, e) (((normalizedM) & MANTISSA_MASK) | ((uint64_t)((e) + E_OFFSET) << 52))
  ...
  do
    {
      if ((*pArg1 != 0) || (intermediate != 0))
        {
          prod1 =
            ((uint64_t) (LOW_U32_FROM_VAR (arg2))) * ((uint64_t) (LOW_U32_FROM_PTR (pArg1)));
          ...
          prod1 =
            ((uint64_t) (LOW_U32_FROM_VAR (arg2))) * ((uint64_t) (HIGH_U32_FROM_PTR (pArg1)));
          prod2 =
            ((uint64_t) (HIGH_U32_FROM_VAR (arg2))) * ((uint64_t) (LOW_U32_FROM_PTR (pArg1)));
          ...
          intermediate = carry1 + HIGH_IN_U64 (intermediate)
            + ((uint64_t) (HIGH_U32_FROM_VAR (arg2))) * ((uint64_t) (buf32));
        }
      pArg1++;
    }
  while (++index < length);
