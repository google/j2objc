...
public class ForkJoinWorkerThread extends Thread {
    ...
    private static final boolean casSlotNull(ForkJoinTask<?>[] q, int i,
                                             ForkJoinTask<?> t) {
        return UNSAFE.compareAndSwapArrayObject(q, i, t, null);
    }
    ...
    private static final void writeSlot(ForkJoinTask<?>[] q, int i,
                                        ForkJoinTask<?> t) {
        UNSAFE.putArrayObjectVolatile(q, i, t);
    }
        ...
        if (q != null && (m = q.length - 1) >= 0) {
            for (int s; (s = queueTop) != queueBase;) {
                ...
                if (t == null)   // lost to stealer
                    break;
                if (UNSAFE.compareAndSwapArrayObject(q, i, t, null)) {
    ...
    final boolean unpushTask(ForkJoinTask<?> t) {
        ...
        if ((q = queue) != null && (s = queueTop) != queueBase &&
            UNSAFE.compareAndSwapArrayObject
            (q, ((q.length - 1) & --s), t, null)) {
            queueTop = s; // or putOrderedInt
            return true;
        }
        return false;
