...
public class EventSetDescriptor extends FeatureDescriptor {
    ...
    public EventSetDescriptor(Class<?> sourceClass, String eventSetName,
        ...
        if (addListenerMethod == null || removeListenerMethod == null) {
            throw new IntrospectionException("Add and remove methods are not available");
        }

        getListenerMethod = findMethodByPrefix(sourceClass, "get", "s");
    ...
    private Method findListenerMethodByName(String listenerMethodName)
        ...
        if (null == result) {
            throw new IntrospectionException("No valid method " +
                    listenerMethodName + " from " + listenerType.getName() + " listener.");
        }
        return result;
    }
    ...
    private void checkNotNull(Object sourceClass, Object eventSetName,
        ...
        if (eventSetName == null) {
            throw new NullPointerException("eventSetName is null");
        }
        if (alistenerType == null) {
            throw new NullPointerException("listenerType is null");
        }
        if (listenerMethodName == null) {
            throw new NullPointerException("listenerMethodName(s) is null");
        }
    }
