...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
  ...
  static final class SparseImmutableTable<R, C, V>
    ...
    ImmutableCollection<V> createValues() {
      @WeakOuter
      class SparseImmutableTableValues extends ImmutableList<V> {
        @Override
        public int size() {
      ...
      return new SparseImmutableTableValues();
    }
  ...
  private abstract static class ImmutableArrayMap<K, V> extends ImmutableMap<K, V> {
    ...
    ImmutableSet<Entry<K, V>> createEntrySet() {
      if (isFull()) {
        @WeakOuter
        class ImmutableArrayMapEntrySetFull extends ImmutableMapEntrySet<K, V> {
        ...
        return new ImmutableArrayMapEntrySetFull();
      } else {
        @WeakOuter
        class ImmutableArrayMapEntrySetNotFull extends ImmutableMapEntrySet<K, V> {
          @Override ImmutableMap<K, V> map() {
            return ImmutableArrayMap.this;
          }
        ...
        return new ImmutableArrayMapEntrySetNotFull();
      }
    }
  }
  ...
  static final class DenseImmutableTable<R, C, V>
    ...
    ImmutableCollection<V> createValues() {
      @WeakOuter
      class DenseImmutableTableValues extends ImmutableList<V> {
        @Override
        public int size() {
          return iterationOrderRow.length;
        }
      ...
      return new DenseImmutableTableValues();
    }
