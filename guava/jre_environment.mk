...
FAILUREACCESS_SRC_JAR = $(JAVA_DEPS_JAR_DIR)/$(FAILUREACCESS_SOURCE_JAR)
JSPECIFY_SRC_JAR = $(JAVA_DEPS_JAR_DIR)/$(JSPECIFY_SOURCE_JAR)

JAR = $(JAVA_DEPS_JAR_DIR)/$(GUAVA_JAR)

OBJS_DIR = $(BUILD_DIR)/objs
GUAVA_FAT_LIB_NAME = guava
GUAVA_FRAMEWORK_NAME = Guava
GUAVA_INCLUDE_DIR = $(ARCH_INCLUDE_DIR)/guava
GUAVA_DIST_JAR = $(DIST_JAR_DIR)/$(GUAVA_JAR)
