...
TRUTH_SRC_JAR = $(JAVA_DEPS_JAR_DIR)/$(TRUTH_SOURCE_JAR)
TRUTH_JAR_FULL = $(JAVA_DEPS_JAR_DIR)/$(TRUTH_JAR)

OBJCFLAGS := $(CC_WARNINGS) $(DEBUGFLAGS)

# J2ObjC settings
J2OBJC = $(DIST_DIR)/j2objc -classpath $(CLASSPATH) -d $(BUILD_DIR)
J2OBJCC = $(ARCH_BIN_DIR)/j2objcc -c $(OBJCFLAGS) -I$(GEN_OBJC_DIR) \
  -I../../dist/include/guava
