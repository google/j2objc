...
// Print stack trace of any uncaught signal and exit.
 ...
 * 
 * J2ObjC: Two changes were made:
 * 
 *  . change main() to doMain(), so that classes with an existing main()
 *    method can use it; and
 *  . a signal handler is installed, so that crashes are reported as test
 *    failures, and any additional tests will be run.
 */
public class TestRunner extends BaseTestRunner {
	...
	private native static void installSignalHandler() /*-[
