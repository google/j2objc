	...
	public Object invokeExplosively(final Object target, final Object... params)
		...
		return new ReflectiveCallable() {
			...
			protected Object runReflectiveCall() throws Throwable {
			  return runReflectiveCall0(fMethod, target, params);
			} 
		}.run();
	}
			
	private static native Object runReflectiveCall0(Method method, Object target, Object... params)
	    throws Throwable /*-[
	  nil_chk(method);
    id result = nil;
	  // Can't use an AutoreleasePool annotation since this method returns a value.
	  @autoreleasepool {
      // Retain/autorelease so returned object survives this pool's release.
      result = RETAIN_([method invokeWithId:target withNSObjectArray:params]);
	  }
